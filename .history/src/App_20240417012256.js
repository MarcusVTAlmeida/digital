        ...
        return (
            ...
            {/* <MDBDropdown>
              ...
              <MDBDropdownMenu basic>
                ...
                <MDBDropdownItem onClick={() => this.setState({ showingretorno: !showingretorno })}>
...
<MDBDropdown>
      <MDBDropdownToggle caret color="info">Dropdown button</MDBDropdownToggle>
      <MDBDropdownMenu basic>
        <MDBDropdownItem link onClick={() => this.setState({ showingretorno: !showingretorno })}>Action</MDBDropdownItem>
        <MDBDropdownItem link onClick={() => this.setState({ showinglocacao: !showinglocacao })}>Another action</MDBDropdownItem>
        <MDBDropdownItem link>Something else here</MDBDropdownItem>
                ...
                <select style={{ width: 175 }} onChange={(e) => this.setState({ remessa: e.target.value })}>
                   <option value="">--DEFINA A REMESSA--
                    ...
                    <option value="Retorno de remessa">Retorno de Remessa</option>            
                </select>
                <br />
                <label>
                    <b>
