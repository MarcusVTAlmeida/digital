...
export default class Retorno extends React.Component {
    constructor(props) {
        ...
        this.getTextUpgr = this.getTextRetorno.bind(this);
        this.state = {            
            ncliente: '',
            ccliente: '',
            volume: '',
...
Volumes: ${this.state.volume} - ${this.state.cubagem} - ${this.state.peso} KGs
...
`;
    ...
    getTextUpgr1() {
        ...
        - Peso: 
        - Quantidade de volumes: ${this.state.volume}
        - Medidas dos volumes:
...
`;
    ...
    <div>            
                    <div style={{ textAlign: 'center' }}><label><b>Retorno de Remessa</b></label></div>
                <br />              
                <br />
                <label>
                    <b>
                    ...
                    <input type="text" style={{ width: 50 }} name="pedidov" value={this.state.pedidov} onChange={(e) => this.setState({ pedidov: e.target.value })} />
                </label> 
                <br />
                <label>
                    <b>
                ...
                <b>
                    ...
                    <input type="text" style={{ width: 200 }} name="transportadora" value={this.state.transportadora} onChange={(e) => this.setState({ transportadora: e.target.value })} />      
                </label> 
                <br />   
                <label> 
                <b>
                ...
                <br />                                  
                    <textarea type="text" style={{ width: 100 }} name="epagador" value={this.state.epagador} onChange={(e) => this.setState({ epagador: e.target.value })} />      
                </label>  
                <br />  
                <br />               
                <label>
                ...
                <br />                                  
                    <textarea type="text" style={{ width: 100 }} name="dendereco" value={this.state.dendereco} onChange={(e) => this.setState({ dendereco: e.target.value })} />      
                </label>    
                <br />
                <br />
                <div style={{ textAlign: 'center' }}>
                    <Clipboard option-text={this.getTextRetorno}>
                        COPIAR
                    </Clipboard>
