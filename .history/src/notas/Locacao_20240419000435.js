...
export default class Retorno extends React.Component {
    constructor(props) {
        ...
        this.getTextUpgr = this.getTextLocacao.bind(this);
        this.state = {            
            ncliente: '',
            ccliente: '',
            volume: '',
...
`;
    ...
    <div>            
                    <div style={{ textAlign: 'center' }}><label><b>Remessa em locação</b></label></div>
                <br />              
                <br />
                <label>
                    <b>
                ...
                <div style={{ textAlign: 'center' }}>
                    <Clipboard option-text={this.getTextLocacao}>
                        COPIAR
                    </Clipboard>
